...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlinePizzeria.Data.DataModels.PizzaSize", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("PizzaModelId")
                        .IsUnique()
                        .HasFilter("[PizzaModelId] IS NOT NULL");

                    b.ToTable("PizzaSize");
                });

            modelBuilder.Entity("OnlinePizzeria.Data.DataModels.WeightOption", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("OnlinePizzeria.Data.DataModels.PizzaSize", b =>
                {
                    b.HasOne("OnlinePizzeria.Model.PizzaModel", null)
                        .WithOne("PizzaSize")
                        .HasForeignKey("OnlinePizzeria.Data.DataModels.PizzaSize", "PizzaModelId");
                });

            modelBuilder.Entity("OnlinePizzeria.Data.DataModels.WeightOption", b =>
                {
                    b.HasOne("OnlinePizzeria.Model.PizzaModel", null)
                        .WithOne("WeightOption")
                        .HasForeignKey("OnlinePizzeria.Data.DataModels.WeightOption", "PizzaModelId");
                });
