        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Veliche = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CreditCardPaymentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OnlinePayment", x => x.CreditCardPaymentId);
                    table.ForeignKey(
                        name: "FK_OnlinePayment_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PizzaModelId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Pizza", x => x.PizzaModelId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OnlinePayment_CustomerId",
                table: "OnlinePayment",
                column: "CustomerId");
